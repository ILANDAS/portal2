...
<div class="container">
     ...
     <div class="post-header">
								<h1 class="entry-title">GOREHCO Y MIDIS ARTICULAN PARA REDUCIR BRECHAS SOCIALES EN SECTORES</h1>
								<div class="post-meta vcard">
									<p><span class="updated">24 May, 2022</span> | <a href="https://wayka.pe/actualidad/" rel="tag">Actualidad</a>, <a href="https://wayka.pe/actualidad/ultimas-noticias/" rel="tag">Últimas Noticias</a></p>
								</div>
			</div>
      ...
      <div class="container" >
                ...
                <div class="carousel-inner" style="max-width: 800px; height: 500px; margin: auto; object-fit: cover;" >
                    <div class="carousel-item active" data-bs-interval="10000"  >
                            <div class="content_item">
                                <img :src="ruta+'./../img/notaprensa(1).jpg'" class="d-block w-100" alt="..." style="object-fit: cover;" >
                            </div>
                    </div>

                    <div class="carousel-item">
                        <div class="content_item">
                        <img :src="'../'+ruta+'./../img/notaprensa(2).jpg'" class="d-block w-100" alt="...">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="content_item">
                        <img :src="'../'+ruta+'./../img/notaprensa(3).jpg'" class="d-block w-100" alt="...">
                        </div>
                    </div>
                </div>
           ...
           <div>
             <meta charset="UTF-8">
             <title> ¿Te gustó este artículo? </title>
...
.single-post article.post .post-header p, .single-post article.post .post-header .post-meta {
    font-size: 16px;
}
